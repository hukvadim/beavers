...
<div class="admin-header">
	<div class="admin-header__title-hold">
		<h2 class="admin-header__title">User add</h2>
	</div>
</div>
...
<form class="admin-form-add form-style js-send-form" enctype="multipart/form-data">
	...
	<input type="hidden" name="form-type" value="admin-user-add">
	...
	<div class="box-input d-flex">
		...
		<input type="email" value="" class="form-control form-control-lg" name="email" placeholder="Email" maxlength="100" minlength="4" required style="max-width: 600px;">
	</div>
	<div class="box-input d-flex">
		...
		<div class="row g-3 w-100" style="max-width: 615px;">
			<div class="col-6">
				<input type="text" value="" class="form-control form-control-lg" name="name" placeholder="Name" maxlength="100" minlength="2" required>
			</div>
			<div class="col-6">
				<input type="text" value="" class="form-control form-control-lg" name="surname" placeholder="Surname" maxlength="100" minlength="2" required>
			</div>
		</div>
	</div>
	<div class="box-input d-flex">
		<label for="input-article" class="box-input__label fw-bold">Password</label>
		<input type="text" class="form-control form-control-lg" name="password" placeholder="User password" maxlength="85" minlength="4" autocomplete style="max-width: 600px;">
	</div>

	<div class="box-submit d-flex gap-4 mt-4 label-offset">
		<button class="btn btn-submit btn-primary btn-lg">Add profile</button>
