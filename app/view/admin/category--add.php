...
<div class="admin-header">
	<div class="admin-header__title-hold">
		<h2 class="admin-header__title">Add category</h2>
	</div>
</div>
...
<form class="admin-form-add form-style js-send-form" enctype="multipart/form-data">
	...
	<input type="hidden" name="form-type" value="admin-category-add">
	...
	<div class="box-input d-flex align-items-center">
		...
		<input type="text" id="input-title" class="form-control form-control-lg" name="title" placeholder="Category title" maxlength="100" minlength="4" required>
	</div>

	<div class="box-submit d-flex gap-4 mt-4 label-offset">
		<button class="btn btn-submit btn-primary btn-lg">Add category</button>
